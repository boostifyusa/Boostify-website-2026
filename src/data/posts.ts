export const blogPosts: Record<string, any> = {
  ...
  'seo-mistakes': {
    ...
    content: `
        ...
        <p>
          <strong class="text-dark">The fix:</strong> Update your profile
        ...
        <p>
          <strong class="text-dark">The fix:</strong> Compress images,
        ...
        <p>
          <strong class="text-dark">The fix:</strong> Publish at least 2
  ...
  'website-leads': {
    ...
    content: `
        ...
        <div class="bg-red-50 border-l-4 border-red-500 p-6 my-6">
          <strong class="text-red-700 block mb-2">The Mistake:</strong>
          <p class="!mb-0 text-red-600">
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-6 my-6">
          <strong class="text-green-700 block mb-2">The Fix:</strong>
          <p class="!mb-0 text-green-800">
  ...
  'get-more-google-reviews': {
    ...
    content: `
        ...
        <p>
          <strong class="text-dark">Best moments to ask:</strong>
        </p>
        <ul class="list-disc pl-6 space-y-2">
          <li>
        ...
        <div class="bg-light rounded-2xl border border-gray-light p-6 my-6 font-mono text-base">
          <p class="!mb-0">
        ...
        <p>
          <strong class="text-dark">For positive reviews:</strong> Thank
        ...
        <p>
          <strong class="text-dark">For negative reviews:</strong> Stay
