...
export function MercedMarketingAgencyPage() {
    ...
    return (
        <div className="min-h-screen bg-white selection:bg-orange selection:text-white">
            <SeoHead title="Merced Marketing Agency: Top-Rated Web Design & SEO | Boostify USA" description="Boostify USA is a premier Merced marketing agency. Custom websites, local SEO, and Google Ads built for Merced County's booming market." canonicalUrl="/merced-marketing-agency" />
            <Helmet>
